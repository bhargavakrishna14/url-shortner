...
import dev.bhargav.urlShortener.dto.response.ErrorResponse;
...
//Global exception handler for handling specific exceptions and
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleGenericException(Exception e) {
        return generateDefaultErrorMessage(e, HttpStatus.INTERNAL_SERVER_ERROR);
    }
}
